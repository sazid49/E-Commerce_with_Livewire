  ...
  <div class="container">
    ...
    <div class=" main-content-area">
      ...
      <div class="wrap-iten-in-cart">
        ...
        <ul class="products-cart">
          ...
          <li class="pr-cart-item">
            ...
            <div class="price-field sub-total"><p class="price">$ {{ $item->model->regular_price }}</p></div>
            <div class="delete">
  	...
  	@if(Session::has('coupon'))
        ...
        <span class="title">
          Discount {{(Session::get('coupon')['type'] == 'fixed') ? '$' : '%' }}({{Session::get('coupon')['code']}})
           <a href="#" wire:click.prevent= "removeCoupon">
             <i class="fa fa-times text-danger"></i>
           </a>
           <b class="index">
              {{(Session::get('coupon')['type'] == 'fixed') ? '$' : '%' }}
               {{number_format($discount,2)}}
             </b>
           </p>
  		<p class="summary-info"><span class="title">Subtotal with Discount</span></span><b class="index">${{number_format($subtotalAfterDiscount)}}</b></p>
  		<p class="summary-info"><span class="title">Tax ({{config('cart.tax')}}%)</span></span><b class="index">${{number_format($taxAfterDiscount)}}</b></p>
    ...
    <div class="summary-item">
      <form wire:submit.prevent="applyCouponCode">
        ...
        <p class="row-in-form">
          ...
          <input type="text" name="coupon-code" wire:model="couponCode" style="background: #d1d1d1;" />
        </p>
   ...
   @endif
      <div class="wrap-iten-in-cart">
        ...
        @if (Session::has('s_success_message'))
          <div class="alert alert-success">
            <strong>{{ Session::get('s_success_message') }}</strong>
          </div>
        @endif
        ...
        <ul class="products-cart">
          ...
          <li class="pr-cart-item">
            ...
            <div class="price-field produtc-price"><p class="price">$ {{ $item->model->regular_price }}</p></div>
            <div class="quantity">
              <p class="text-center"><a href="" wire:click.prevent="moveToCart('{{ $item->rowId }}')">Save For Later</a> </p>
