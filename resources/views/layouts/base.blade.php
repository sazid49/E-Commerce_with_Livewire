...
<head>
	...
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datetimepicker/4.17.37/css/bootstrap-datetimepicker.min.css" integrity="sha512-WWc9iSr5tHo+AliwUnAQN1RfGK9AnpiOFbmboA0A0VJeooe69YR2rLgHw13KxF1bOSLmke+SNnLWxmZd8RTESQ==" crossorigin="anonymous" referrerpolicy="no-referrer" />
                         {{--End  ON SALE timer  datetimepicker--}}
											  {{-- noUiSlider price filtering--}}
...
<body class="home-page home-01 ">
                       ...
                       @if(Auth::user()->utype==='ADM')
												 <li class="menu-item menu-item-has-children parent" >
 													...
 													<ul class="submenu curency" >
 														...
 														<li class="menu-item" >
 															<a title=" Manage Home Slider" href="{{route('admin.slider')}}">Manage Home Slider</a>
 														</li>
 														<li class="menu-item" >
 														...
 														<li class="menu-item" >
 															<a title="All Orders" href="{{route('admin.orders')}}">All Ordeers</a>
 														</li>
 														<li class="menu-item" >
 															<a title="Contact Message" href="{{route('admin.contact')}}">Contact Message</a>
 														</li>
 														<li class="menu-item" >
 															<a title="Settings" href="{{ route('admin.settings') }}">Setings</a>
 														</li>
 														<li class="menu-item" >
 															<a title="Brands" href="{{ route('admin.brands') }}">All Brand</a>
 														</li>
														<li class="menu-item" >
															<a  href="{{route('logout')}}" onclick="event.preventDefault(); document.getElementById('logout-form').submit(); confirm('Are you sure, You want to logout?') || event.stopImmediatePropagation()">Logout</a>
														</li>
 ...
 {{ $slot }}
  ...
  <script src="https://cdn.tiny.cloud/1/ska1so7tu2oswlp2dwu5rj7x1qy4jz7djnxaznnqqju9gfo9/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
	@livewireScripts
	@stack('scripts')
</body>
</html>
